...
public class Level_01_Register_DRY {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		driver.findElement(By.cssSelector("input#Email")).sendKeys("12312434");
	...
	@Test
	public void TC_05_Register_Existing_Password_Less_Than_6_Chars() {
		driver.findElement(By.cssSelector("a.ico-register")).click();
		driver.findElement(By.cssSelector("input#FirstName")).sendKeys("automation");
		driver.findElement(By.cssSelector("input#LastName")).sendKeys("abc");
		driver.findElement(By.cssSelector("input#Email")).sendKeys(emailAddress);
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		driver.findElement(By.cssSelector("input#LastName")).sendKeys("abc");
		driver.findElement(By.cssSelector("input#Email")).sendKeys(emailAddress);
		driver.findElement(By.cssSelector("input#Password")).sendKeys("12334345");
